  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-10  md:mt-20 bg-gradient-to-br from-neutral-300 to-neutral-500 py-2 md:py-4 bg-clip-text text-center text-2xl sm:text-3xl md:text-4xl lg:text-7xl font-medium tracking-tight text-transparent"
      >
        Plans That
        <br /> Fit You Best
      </motion.h1>
